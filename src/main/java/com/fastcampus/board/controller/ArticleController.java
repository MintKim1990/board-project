...
import com.fastcampus.board.response.ArticleResponse;
import com.fastcampus.board.response.ArticleWithCommentsResponse;
...
public class ArticleController {
    ...
    public String articles(
        ...
        Page<ArticleResponse> artibles = articleService.searchArticles(searchType, searchValue, pageable).map(ArticleResponse::from);
        List<Integer> barNumbers = paginationService.getPaginationBarNumbers(pageable.getPageNumber(), artibles.getTotalPages());

        map.addAttribute("articles", artibles);
